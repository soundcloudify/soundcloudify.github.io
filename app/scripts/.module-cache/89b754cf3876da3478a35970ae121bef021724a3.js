		...
		return (
			React.createElement("li", {id: 'track-item-' + track.id, className: "track-item"}, 
				...
				React.createElement("div", {className: "md-tile-hover"}, 
			        starButton, 
			        React.createElement("i", {className: "add-to-playlist-btn icon ion-ios-paperplane", onClick: this.onAddTrackToPlaylist}), 
			        React.createElement("i", {className: "add-to-playlist-btn icon ion-ios-plus-empty", onClick: this.onAddTrackToPlaylist}), 
				    removeButton
				)
			)
		);
